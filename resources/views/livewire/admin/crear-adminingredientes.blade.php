<div>
    <div class="text-sm cursor-point font-light ">
        <p wire:click="$set('open', true)"
            class="text-base border-b-2 border-transparent hover:border-red-700 cursor-pointer">Nuevo Ingrediente</p>
    </div>
    ...
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="title">
            <p class="font-bold text-left pb-4 border-b text-zinc-800">Crear Nuevo Ingrediente</p>
        </x-slot>
